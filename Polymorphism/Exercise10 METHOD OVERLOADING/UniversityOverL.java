...
void studentDetails() {
System.out.println("Student: varshith");
...
student.studentDetails("varshith"); 
student.studentDetails("friend1 ", "MSc in Data Science"); 
student.studentDetails("friend2", "PhD in AI", 2025);
}
}